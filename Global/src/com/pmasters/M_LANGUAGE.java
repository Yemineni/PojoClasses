...
public class M_LANGUAGE implements  Serializable{
	...
	public M_LANGUAGE(String cOMPANY_CODE, String lANG_CODE, String lANG_DESCR, String cREATION_DATE, String uSER_ID,
			String mACHINE_ID) {
		super();
		COMPANY_CODE = cOMPANY_CODE;
		LANG_CODE = lANG_CODE;
