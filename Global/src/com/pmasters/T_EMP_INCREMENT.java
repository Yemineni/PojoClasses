...
@Entity
@Table(name="HR.T_EMP_INCREMENT")
@IdClass(T_EMP_INCREMENT_PK.class)
public class T_EMP_INCREMENT implements Serializable {

	public T_EMP_INCREMENT() {
	...
	@Column
	String MACHINE_ID        ="";
	public T_EMP_INCREMENT(String cOMPANY_CODE, String eMP_CODE,
