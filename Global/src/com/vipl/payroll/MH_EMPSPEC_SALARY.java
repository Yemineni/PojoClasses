...
@Entity
@Table(name="HR.MH_EMPSPEC_SALARY")
@IdClass(M_EMPSPEC_SALARY_Pk.class)
public class MH_EMPSPEC_SALARY implements Serializable {
	...
	public MH_EMPSPEC_SALARY(String cOMPANY_CODE, String eMP_CODE,
