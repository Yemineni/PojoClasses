...
@Entity
@Table(name="hr.t_emp_accrual_ent")
@IdClass(T_EMP_ACCRUAL_ENT_pk.class)
public class T_EMP_ACCRUAL_ENT implements Serializable {

	public T_EMP_ACCRUAL_ENT() {
		// TODO Auto-generated constructor stub
	}
	public T_EMP_ACCRUAL_ENT(String cOMPANY_CODE, String eMP_CODE,
