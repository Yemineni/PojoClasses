...
@Entity
@Table(name="HR.FFD_EARN_PAYROLL")
@IdClass(FFD_EARN_PAYROLL_pk.class)

public class FFD_EARN_PAYROLL implements Serializable {

	public FFD_EARN_PAYROLL() {
	...
	public FFD_EARN_PAYROLL(String cOMPANY_CODE, String eMP_CODE,
