...
public class T_OLD_EMPLOYEE_INPUT {
	...
	@Column String PROBATION_START_DATE   ;       
	@Column String CONFIRMATION_DATE       ;      
	...
	@Column String SEPR_DATE               ;      
	@Column String SEPR_TYPE              ;
	@Column String SEPR_REASON            ;
	...
	public String getSEPR_DATE() {
		return SEPR_DATE;
	}
	public void setSEPR_DATE(String sEPR_DATE) {
		SEPR_DATE = sEPR_DATE;
	}
	...
	public T_OLD_EMPLOYEE_INPUT(String cOMPANY_CODE, String sAL_MONTH,
			String dIV_CODE, String sUBDIV_CODE, String sR_NO, String eMP_CODE,
			String eMP_FIRSTNAME, String eMP_MIDDLENAME, String eMP_SURNAME,
			String eMP_FATHER_NAME, String eMP_DOB, String eMP_DOJ,
			String pROBATION_START_DATE, String cONFIRMATION_DATE,
			...
			String bANK_ACCOUNT_NO, String pF_NO, String pF_JOINING_DATE,
			String eSI_NO, String eSI_JOINING_DATE, String sEPR_DATE,
			String sEPR_TYPE, String sEPR_REASON, String oFFICE_EMAIL_ID,
			String rEMARKS, String mACHINE_ID, String uSER_ID,
